                     ...
                     _In_ int       nCmdShow)
{
	...
	while (true)
	{
		...
		float		fTimeDelta = pGameInstance->Compute_TimeDelta(TEXT("Timer_Default"));

		fTimeAcc += fTimeDelta;

		if(fTimeAcc > 1.0f / 60.0f)
		{	
			_float		fTimeDelta_60 = pGameInstance->Compute_TimeDelta(TEXT("Timer_60"));
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   HWND hWnd = CreateWindowW(szWindowClass, L"Animal Crossing : Jusin", WS_OVERLAPPEDWINDOW,
