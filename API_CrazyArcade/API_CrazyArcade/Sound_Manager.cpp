...
void CSound_Manager::PlaySound(const TCHAR* pSoundKey, CHANNELID eID)
{
	...
	{
		FMOD_System_PlaySound(m_pSystem, FMOD_CHANNEL_REUSE, iter->second, FALSE, &m_pChannelArr[eID]);
	}
