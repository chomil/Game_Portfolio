...
CScene_Monster1::CScene_Monster1()
{
}
...
int CScene_Monster1::Ready_Scene()
{
	...
	CTile_Manager::Get_Instance()->Load_Data_Tile_Manager(L"../Data/tile_monster1.dat");
	CTile_Manager::Get_Instance()->Load_Data_Block_Manager(L"../Data/block_monster1.dat");

	CGameObject* pMonster = CMonster::Create(TILESTARTX + 0 * TILECX, TILESTARTY + 2 * TILECY, DIRECTION::DIREC::RIGHT, 0);
	if (nullptr != pMonster)
	{
		CGameObject_Manager::Get_Instance()->Add_GameObject(OBJECT::MONSTER, pMonster);
	}
	pMonster = CMonster::Create(TILESTARTX + 0 * TILECX, TILESTARTY + 4 * TILECY, DIRECTION::DIREC::RIGHT, 0);
	if (nullptr != pMonster)
	{
		CGameObject_Manager::Get_Instance()->Add_GameObject(OBJECT::MONSTER, pMonster);
	}
	pMonster = CMonster::Create(TILESTARTX + 0 * TILECX, TILESTARTY + 10 * TILECY, DIRECTION::DIREC::RIGHT, 0);
	if (nullptr != pMonster)
	{
		CGameObject_Manager::Get_Instance()->Add_GameObject(OBJECT::MONSTER, pMonster);
	}
	pMonster = CMonster::Create(TILESTARTX + 0 * TILECX, TILESTARTY + 12 * TILECY, DIRECTION::DIREC::RIGHT, 1);
	if (nullptr != pMonster)
	{
		CGameObject_Manager::Get_Instance()->Add_GameObject(OBJECT::MONSTER, pMonster);
	}

	pMonster = CMonster::Create(TILESTARTX + 14 * TILECX, TILESTARTY + 0 * TILECY, DIRECTION::DIREC::LEFT, 1);
	if (nullptr != pMonster)
	{
		CGameObject_Manager::Get_Instance()->Add_GameObject(OBJECT::MONSTER, pMonster);
	}
	pMonster = CMonster::Create(TILESTARTX + 14 * TILECX, TILESTARTY + 2 * TILECY, DIRECTION::DIREC::LEFT, 0);
	if (nullptr != pMonster)
	{
		CGameObject_Manager::Get_Instance()->Add_GameObject(OBJECT::MONSTER, pMonster);
	}
	...
	pMonster = CMonster::Create(TILESTARTX + 14 * TILECX, TILESTARTY + 10 * TILECY, DIRECTION::DIREC::LEFT, 0);
	if (nullptr != pMonster)
	{
		CGameObject_Manager::Get_Instance()->Add_GameObject(OBJECT::MONSTER, pMonster);
	}
	...
	POINT startPos[4] = { {200,300},{280, 300},{360,300},{440,300} };
...
void CScene_Monster1::Update_Scene()
{
...
void CScene_Monster1::Render_Scene(HDC hDC)
{
...
void CScene_Monster1::Release_Scene()
{
...
CScene* CScene_Monster1::Create()
{
	CScene* pInstance = new CScene_Monster1;
